...
public class Main
{
	public static void main(String[] args)
	{
		...
		//Calculator cal = new CalculatorImpl();		//주업무 불러와서 cal에 담음
		...
		*/
		...
		Calculator proxy = (Calculator) Proxy.newProxyInstance(
				...
				, cal.getClass().getInterfaces() 	//주 업무 실행 클래스의 인터페이스 대한 정보 전달(제공)
				, new CalculatorProxty(cal)			//보조 업무 실행 클래스에 대한 정보 전달(제공)
				);
